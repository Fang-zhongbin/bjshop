...
<head>
<title>ECSHOP 管理中心 - 商品栏目列表 </title>
...
<h1>
<span class="action-span"><a href="<?php echo U('add');?>">添加栏目</a></span>
<span class="action-span1"><a href="#">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品栏目 </span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php foreach($catedata as $v){ ?>
    ...
    <td align="left" class="first-cell" style = 'padding-left="0"'>
            <?php echo str_repeat('&nbsp;&nbsp;',$v['lev']*2) ?><img src="/Public/Admin/images/menu_minus.gif" id="icon_0_1" width="9" height="9" border="0" style="margin-left:0em" />
    ...
    <td width="24%" align="center">
      ...
      <a href="<?php echo U('del',array('cat_id'=>$v['id']))?>" title="删除" onclick="return confirm('你真的要删除吗?')">删除</a>
    </td>
  </tr>
  <?php } ?>
  </table>
