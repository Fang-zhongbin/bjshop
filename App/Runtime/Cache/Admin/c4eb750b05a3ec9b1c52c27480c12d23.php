      ...
      <form enctype="multipart/form-data" action="/Admin/Goods/add" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <option value="<?php echo $v['id']?>" ><?php echo str_repeat('&nbsp;&nbsp;',$v['lev']*2).$v['cat_name']?></option>/select>
            <?php }?>
             </td>
          </tr>
          <tr>
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
          ...
          <tr>
            ...
            <img src="/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息">
            </a> 商品库存数量：
            </td>
        ...
        <table width="90%" id="attr-table" style="display:none">
          <tr>
            <td>商品类型：</td><td><select name="goods_type_id">
                <option >请选择商品类型</option>
                <?php  foreach($typedata as $v){?>
                             <option  value="<?php echo $v['id']?>"><?php echo $v['type_name_id']?></option>
                <?php }?>
            </select></td>
