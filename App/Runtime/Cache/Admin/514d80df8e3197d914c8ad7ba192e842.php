...
<h1>
<span class="action-span"><a href="<?php echo U('Type/add');?>">添加类型</a></span>
<span class="action-span1"><a href="#">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 商品类型 </span>
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php foreach($typedata as $v){?>
    ...
    <td width="50%"><?php echo $v['type_name']?></td>
